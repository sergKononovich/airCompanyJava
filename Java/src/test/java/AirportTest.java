...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        Assert.assertSame(transportMilitaryPlanes.get(0).getMilitaryType(), MilitaryType.TRANSPORT);
    }
    ...
    @Test
    public void testNextPlaneMaxCapacityIsHigherThanCurrent() {
        Airport airport = new Airport(planes);
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        ...
        Assert.assertNotSame(experimentalPlanes.get(1).getClassificationLevel(), ClassificationLevel.UNCLASSIFIED);
    }
}
